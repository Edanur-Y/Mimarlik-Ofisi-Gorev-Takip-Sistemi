...
VALUES 
('Çorum','Kargı', 'Fatih Mah.', 'Sarı Sok.', 10, 2, 4),
('Ankara','Altındağ', 'Kara Mah.', 'Sedef Sok.', 23, 3, 12);
INSERT INTO KisiAdresleri
(Il, Ilce, Mahalle, Cadde, Sokak, BinaNo, KatNo, DaireNo)
VALUES 
('Çorum','Kargı', 'Buğday Mah.', 'Atatürk Cad.','İpek Sok.', 5, 1, 1);

INSERT INTO ArsaAdresleri
(Il, Ilce, Mahalle, AdaParselNo)
VALUES 
('Çorum','Kargı', 'Yeni Mah.', '255/2'),
('Çorum','Kargı', 'Bahçelievler Mah.', '179/5'),
('Çorum','Kargı', 'Bayır Mah.', '142/6'),
('Çorum','Kargı', 'Yeni Mah.', '238/7');
...
VALUES 
(2, 'Belediye Şantiyesi', 1, 1, 1, 1, 1, 150000, 0, 'https://drive.google.com/file/d/1WEuY6mf4qZQiy27xTNY_1UtMT-3PHe5H/view?usp=drive_link',
'https://drive.google.com/file/d/1wSpRFP32rolCi4XLUZ0zAKJ3CjYeI9Bm/view?usp=drive_link', '2024-12-30', Null),
(1, 'Köşe Projesi', 2, 2, 2, 2, 2, 140000, 1, 'https://drive.google.com/file/d/1XYk7cV2w_znzyOTIP0b9963AvbD_Y9NY/view?usp=drive_link',
'https://drive.google.com/file/d/1q8LifIj0DuGBA2gMb7SjKavjfbXw3MgG/view?usp=drive_link', '2025-01-15', '2025-02-15'),
(1, 'Pazar Yanı Proje', 1, 3, 3, 3, 3,  160000, 0, 'link3', 'link4', '2025-02-03', Null),
(2, 'Tepe Şantiyesi', 3, 4, 4, 4, 4, 170000, 1, 'link5', 'link6', '2025-02-10', '2025-04-30') 
